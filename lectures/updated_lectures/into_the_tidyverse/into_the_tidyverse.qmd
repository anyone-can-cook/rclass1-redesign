---
title: "Into the tidyverse: pipes, dplyr, and variable creation"
author: ""
date: ""
format: html
toc: true
...
__Select variables using `select()` function__
...
__The `filter()` function, base R equivalents__
...
__Filter, character variables__
...
__Filter by multiple conditions, base R equivalents__
...
-   start with `wwlist` **and then** select a few vars **and then** filter **and then** sort **and then** investigate structre of object
