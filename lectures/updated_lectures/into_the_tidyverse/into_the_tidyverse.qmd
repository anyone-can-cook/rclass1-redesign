...
\medskip `count()` function from `dplyr` package counts the unique values of one or more variables. 
...
### Practice exercise: Run the following code with and without pipes \[Work through on your own\]
