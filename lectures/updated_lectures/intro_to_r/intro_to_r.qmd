...
-   VIDEO ON WHAT IS R MARKDOWN: <https://www.youtube.com/watch?v=asHhuHRxhvo>
...
<!--
sources:
https://www.youtube.com/watch?v=z4813fLJzAU
* Streamline interactive dashboards
https://www.youtube.com/watch?v=cB2wu79Ar6o
* Quarto is the updated version of R markdown which allows you to embed code into a document you are creating
* Essentially a word processor 
* Compatible with markdown
* Slide presentations using revealjs, two ## for name of slide, insert code chunks, set incremental: true for pauses on slides for bullet point and numbered lists  . . . for manual pauses in slide 
* good for referencing tables/figs
* easy for bibliographies 
