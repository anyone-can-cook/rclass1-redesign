...
dt %>%
  kbl(caption = "Table 1. The six types of atomic vectors in R: double, integer, logical, character, complex, and raw") %>%
...
__"Length" of an atomic vector is the number of elements__
