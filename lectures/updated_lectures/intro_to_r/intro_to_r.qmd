...
\medskip For remainder of lecture, I'll use the term **vector** to refer to atomic vectors
...
\medskip \*\*Functions\*\* are pre-written bits of code that accomplish some task.
