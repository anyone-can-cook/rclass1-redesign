...
__Installing and Loading R packages__
...
[Pane Layout from RStudio User Guide](https://docs.posit.co/ide/user/ide/guide/ui/ui-panes.html)
![](pane_layout_23.jpeg)
...
- Quarto is..... 
- TEXT HERE ABOUT QUARTO
- HOW & WHY WE WILL BE USING QUARTO FOR THIS CLASS  
- COME BACK TO THIS
...
R is an "object-oriented" programming language (like Python, JavaScript). So, what is an __object__?
...
__The fundamental data structure in R is the "vector"__
...
__Formal classification of vectors in R__
...
__Visual representation of the Grolemund and Wickham classification__
...
<br>
__Let's practice creating simple vectors__
...
__Data type of a vector, numeric__
...
__Data type of a vector, character__
...
__Data type of a vector, logical__
...
__All elements in (atomic) vector must have same data type.__
...
__Create lists using `list()` function__
...
__Investigate structure of lists using `str()` function__
...
__Elements within lists can have different data types__
...
__Lists can contain other lists__
...
The __first element__ of list is a numeric vector with length=2  
```{r}
x1[[1]]
```

The __second element__ is a list with length=2  
...
The __third element__ is a list with length=3  
...
__You can name each element in the list__
...
__Access individual elements in a "named" list__
...
__Compare structure of list to structure of element within a list__
...
__A data frame is a named list__
...
__Working directory, "Code chunks" vs. "console" and "R scripts"__
...
__Absolute vs. relative filepath__
...
__File path visual__

![](fp1.JPG){width="200px"} ![](fp2.JPG){width="200px"}

__Exercise continued__
...
__How to create an "R project"__
...
__Next, you follow these steps__
...
__Creating R Markdown documents__
...
__Learning more about R Markdown__
...
__Like atomic vectors, matrices are homogenous data structures__
...
__Why are data frames based on lists rather than matrices?__
...
__How are matrices used in R__
