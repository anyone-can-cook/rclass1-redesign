...
Many journals require grayscale graphs or figures. You can use the `scale_color_grey()` function for continuous or the `scale_fill_grey()` function for discrete color scales. 
