...
The course primarily use data and examples from social science research and designed to teach skills that are important for social science research more broadly and also for computational research within the humanities. __We welcome students from across the university__.
...
- Except for the first problem set, students will complete problem sets in groups of 3. We highly encourage students who are abroad to form their own group to set aside time to work on the problem sets together.
