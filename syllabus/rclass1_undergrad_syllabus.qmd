...
Resource <- c("Weekly meetings (online) \n\ \t - Hello","Class website (public)", "Questions, discussion, announcements (private)", "Class Zoom link")
Link <- c("Day(s), Time, Timezone","Link to website here", "Link to class repository for student issues here",  "Zoom link here")
...
The LGBTQ resource center provides a range of education and advocacy services supporting intersectional identity development. It fosters unity; wellness; and an open, safe, inclusive environment for lesbian, gay, bisexual, intersex, transgender, queer, asexual, questioning, and same-gender-loving students, their families, and the entire campus community. Find it in the Student Activities Center, or via email lgbt\@lgbt.ucla.edu, & website https://www.lgbt.ucla.edu/. 
...
- [Map to all-gender restrooms](https://www.lgbt.ucla.edu/Portals/38/Documents/GIRR%20Map%2007-2019%20Compressed.pdf)  
...
## Data Resources 
Data squad https://www.library.ucla.edu/about/programs/ucla-library-datasquad/
