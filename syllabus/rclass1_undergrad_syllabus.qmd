...
__AI in the classroom__
  
  - 


# Campus resources [CONSIDER CREATING A TABLE TO MINIMIZE SPACE]
...
Description <- c("As a student, you may experience a range of issues that can cause barriers to learning, such as strained relationships, increased anxiety, alcohol/drug problems, depression, difficulty concentrating, and/or lack of motivation that may lead to diminished academic performance or reduce your ability to participate in daily activities.",
                 ...
                 "",
                 "", 
                 "UCLA Student Legal Services provides a range of legal support to all registered and enrolled UCLA students. Some of their services include: Landlord/Tenant Relations (Including challenges during COVID), Accident and Injury Problems, Domestic Violence and Harassment, Divorces, and Other Family Law matter",
...
Contact <- c("To speak directly with a counselor 24/7 at (310) 825-0768, if an emergency call 911 \nLocated in the Wooden Center West \nWebsite: https://www.caps.ucla.edu",
             "Email: lgbt@lgbt.ucla.edu \n Located in the Student Activities Center \nWebsite: https://www.lgbt.ucla.edu/",
             "Website: https://www.internationalcenter.ucla.edu/",
             "Email: usp@saonet.ucla.edu \nWebsite: https://www.usp.ucla.edu/ ",
             "Website: https://www.swd.ucla.edu/",
             "Website: https://bewellbruin.ucla.edu/",
             "Website: https://www.library.ucla.edu/about/programs/ucla-library-datasquad/", 
             "Website: http://www.studentlegal.ucla.edu/index.php",
             "Website: https://equity.ucla.edu/report-an-incident/")
...
ft3 <- ft3 %>% 
  width(width = 2) %>%
  width(j = "Resource", width = 1.5, unit = "in") %>%
  width(j = "Description", width = 3.5, unit = "in") %>%
  bg(bg = "#8569B8", part = "header") %>% #3173C9, #8569B8
...
- [Campus accessibility map](https://map.ucla.edu/downloads/pdf/Access_Oct_2020.pdf)
