...
# Question 1: Practice making changes to the YAML header [PROVIDE R MARKDOWN FOR THEM? OR HAVE THEM PRACTICE CREATING .QMD FILE, AND UPDATING YAML HEADER? TO CHECK WE CAN HAVE THEM RUN LS(), MAYBE CAT?]
...
3.  In this question we will use the `[]` to subset a list/data frame:
    ...
    + Return the 1st element of the list `list` using `[]`
      + What is the data type? __ANSWER:__  
